...
public class GenericHelper {
    ...
    public static ArrayList<Object> valeurs(Object o) throws Exception{
        Class cl=o.getClass();
        ArrayList<Field>inserer=getNonull(o);
        ArrayList<Object> valeur=new ArrayList<>();
        for(int i=0;i<inserer.size();i++){
             
             if(get(o,inserer.get(i).getName()) instanceof Date){
                 if(get(o,inserer.get(i).getName()) instanceof Timestamp){       
                Timestamp daty=(Timestamp)get(o,inserer.get(i).getName());
              
                valeur.add(new java.sql.Timestamp(daty.getTime()));
            }else{
                      Date daty=(Date)get(o,inserer.get(i).getName());
    ...
    public static ArrayList<Object> valeursupdate(Object o) throws Exception{
        Class cl=o.getClass();
        ArrayList<Field>inserer=getNonull(o);
        ArrayList<Object> valeur=new ArrayList<>();
        for(int i=0;i<inserer.size();i++){
             if(GenericHelper.isAttr(inserer.get(i))!=null){
             if(get(o,inserer.get(i).getName()) instanceof Date){
                 if(get(o,inserer.get(i).getName()) instanceof Timestamp){       
                Timestamp daty=(Timestamp)get(o,inserer.get(i).getName());
    ...
    //select
      public static Attribut getAttribut(Field o)throws Exception{
            ...
            throw new  Exception(o.getName()+" is not an attribut in your table");
