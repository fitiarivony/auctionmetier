    ...
    public static boolean save(Object o,Connect conn)throws Exception{
        ...
        System.out.println(stat);
         ...
         return true;
            ...
            System.out.println(conn.getAutoCommit()+"----autocommit");
     ...
     public static boolean update(Object o,Connect conn) throws  Exception{
        ...
        try{
             conn.getConnection(); 
             ArrayList<Field> attributs=GenericHelper.getNonull(o);
             for(int i=0;i<attributs.size();i++){
                 if(GenericHelper.isAttr(attributs.get(i))!=null){
                    System.out.println(attributs.get(i).getName()+"n'est pas primary");
            ...
            sql+=GenericHelper.isPrimary(GenericHelper.getPrimary(o))+"= ? ";
             stat=conn.prepareStatement(sql);
            ArrayList<Object> valeurs=GenericHelper.valeursupdate(o);
            int j;
            int i;
...
//               System.out.println(sql);
    ...
    public static String getWhere(Integer i,String sql){
     ...
     public static ArrayList<Object> executeQuery(String sql,Connect conn,Object obj)throws Exception{
      ...
      public static String getLastIdString(Object obj,Connect conn) throws Exception{
         String primary=GenericHelper.isPrimary(GenericHelper.getPrimary(obj));
       String sql="select "+primary+ "   dernier from "+GenericHelper.getNomTable(obj)+" order by substring("+primary+"  from  4)::integer  desc limit 1";
       PreparedStatement stat=null;
       ResultSet res=null;
       try{
           conn.getConnection();
           ...
           System.out.println(stat);
           res=stat.executeQuery();
           while(res.next())return res.getString("dernier");
       }catch(Exception e){
           throw e;
       }finally{
           if(res!=null)res.close();
       ...
       public static Object[] executeQuery(String sql,Connect conn,String attribut)throws Exception{
       PreparedStatement stat=null;
       ResultSet res=null;
